...
namespace ApiTrailers.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public ActionResult<List<Usuarios>> GetIniciarSesion(string Nombre, string Password)
        {
            var usuarios = _context.Usuarios.Where(usuario => usuario.Nombre.Equals(Nombre) && usuario.Password.Equals(Password)).ToList();
